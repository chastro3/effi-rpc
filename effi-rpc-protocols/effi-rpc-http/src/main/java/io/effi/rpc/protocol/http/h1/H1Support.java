...
public class H1Support {
     ...
     */
    public static HttpResponse<ByteBuf> fromFullHttpResponse(FullHttpResponse response, InvocationContext<Envelope.Request, Caller<?>> context) {
        Http1Caller<?> caller = (Http1Caller<?>) context.invoker();
