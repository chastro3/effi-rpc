...
/**
 * Provides the default implementation of {@link HttpEnvelope}.
 */
public abstract class DefaultHttpEnvelope<BODY> implements HttpEnvelope<BODY> {
    ...
    protected DefaultHttpEnvelope(HttpVersion version, HttpMethod method, URL url,
    ...
    /**
     * Builds {@link HttpEnvelope} instance and defines configuration.
     */
