...
public class HttpClientCodec extends AbstractClientCodec<HttpRequest<Object>, HttpResponse<ByteBuf>>
    ...
    @Override
    protected Message.Request encodeRequest(WrappedRequest<Caller<?>> wrappedRequest, HttpRequest<Object> request) throws Exception {
    ...
    public Result resolve(HttpResponse<ByteBuf> response, Caller<?> caller) {
        Object replyValue = HttpUtil.decodeBody(response, caller.replyType().type());
