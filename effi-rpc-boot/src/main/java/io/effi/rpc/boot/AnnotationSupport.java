...
public final class AnnotationSupport {
    ...
    public static <C extends Config> C fillConfig(EffiRpcCaller caller, C config) {
        if (caller != null && config != null) {
            ...
            fillKV(config, DefaultConfigKeys.REMOTE_APPLICATION, caller.remoteApplication());
            fillKV(config, DefaultConfigKeys.REMOTE_MODULE, caller.remoteModule());
            ...
            fillKV(config, DefaultConfigKeys.CALLER_THREAD_POOL, caller.threadPool());
    ...
    public static <C extends Config> C fillConfig(EffiRpcClient client, C config) {
        if (client != null && config != null) {
            ...
            fillKV(config, DefaultConfigKeys.REMOTE_APPLICATION, client.remoteApplication());
            fillKV(config, DefaultConfigKeys.REMOTE_MODULE, client.remoteModule());
            ...
            fillKV(config, DefaultConfigKeys.CALLER_THREAD_POOL, client.threadPool());
    ...
    public static <C extends Config> C fillConfig(EffiRpcCallee callee, C config) {
        if (callee != null && config != null) {
            ...
            fillKV(config, DefaultConfigKeys.MODULE, callee.module());
            ...
            fillKV(config, DefaultConfigKeys.CALLEE_THREAD_POOL, callee.threadPool());
    ...
    public static <C extends Config> C fillConfig(EffiRpcService service, C config) {
        if (service != null && config != null) {
            ...
            fillKV(config, DefaultConfigKeys.MODULE, service.module());
            ...
            fillKV(config, DefaultConfigKeys.CALLEE_THREAD_POOL, service.threadPool());
    ...
    private static <T> void fillKV(Config config, DefaultConfigKeys key, T value) {
        if (value == null) {
            return;
        }
        ...
        if (value instanceof String strValue) {
            ...
            throw new IllegalArgumentException(Messages.unSupport(key.key(), value.getClass()));
        }
    }
