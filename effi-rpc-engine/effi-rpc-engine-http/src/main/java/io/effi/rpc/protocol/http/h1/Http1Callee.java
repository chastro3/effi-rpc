...
public class Http1Callee<T> extends HttpCallee<T> {
    ...
    Http1Callee(LinkedConfig config, Http1CalleeBuilder<T> builder) {
     ...
     */
    public static <T> Http1CalleeBuilder<T> builder(MethodMapper<T> methodMapper, LinkedConfig config) {
