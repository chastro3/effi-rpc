...
public class Http2Callee<T> extends HttpCallee<T> {
    ...
    Http2Callee(LinkedConfig config, Http2CalleeBuilder<T> builder) {
     ...
     */
    public static <T> Http2CalleeBuilder<T> builder(MethodMapper<T> methodMapper, LinkedConfig config) {
