...
import static io.effi.rpc.config.ConfigKey.Strategy.CASCADED;
import static io.effi.rpc.config.ConfigKey.Strategy.SELF_ONLY;
import static io.effi.rpc.config.ConfigKey.Strategy.SELF_PREFERRED;
 ...
 */
public enum DefaultConfigKeys implements ConfigKey, ExtensionKeys {
    ...
    FILTERS("filters", CASCADED, null, ","),
    REGISTRIES("registries", CASCADED, null, ","),
    ...
    DefaultConfigKeys(String key, Strategy strategy, Object defaultValue) {
        this(key, strategy, defaultValue, null);
    }

    DefaultConfigKeys(String key, Strategy strategy, Object defaultValue, String separator) {
        this.key = key;
