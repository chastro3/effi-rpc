...
/**
 * Provides the delegate implementation of {@link ExtensionFactory}.
 */
public class DelegateExtensionFactory implements ExtensionFactory {
    ...
    @Override
    public <T> T getExtension(Class<T> type, String[] names) {
    ...
    /**
     * Provides the reflection implementation of {@link ExtensionFactory}.
     */
