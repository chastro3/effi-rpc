...
public abstract class ImmutableInteractionUnitChain<U extends Interaction.Unit, CHAIN extends ImmutableInteractionUnitChain<U, CHAIN>>
    ...
    CHAIN init(
        ...
        AssertUtil.valid(CollectionUtil.isNotEmpty(names), "name(s) cannot be empty");
    ...
    /**
     * Searches this chain and subsequent chains for the given name.
     * Returns null if not found. Recommended to start from the head.
     *
     * @param name the chain name to find
    ...
    /**
     * Supplies execution units by name from a module.
     */
    @FunctionalInterface
    public interface InteractionUnitSupplier<U extends Interaction.Unit> {

        /**
         * Supplies an execution unit for the given module and name.
         *
