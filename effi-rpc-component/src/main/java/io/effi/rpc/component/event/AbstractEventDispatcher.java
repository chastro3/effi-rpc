 ...
 */
public abstract class AbstractEventDispatcher extends ScopedPlatform.Holder implements EventDispatcher {

    protected final Logger logger = LoggerFactory.getLogger(getClass());

    protected final Map<Class<? extends Event<?>>, List<EventListener<?>>> listenerMap = new ConcurrentHashMap<>();

    protected AbstractEventDispatcher(ScopedPlatform platform) {
        super(platform);
    }
